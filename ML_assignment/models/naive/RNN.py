...
class VanillaRNN(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, output_size):
        ...
        # initializat hidden unit

        self.concat_size = input_size + hidden_size
        self.hidden = nn.Linear(self.concat_size, self.hidden_size)

        # initialize output unit

        self.output = nn.Linear(self.concat_size, self.output_size)

        # include tanh and log softmax function
    ...
    def forward(self, input, hidden):
        ...
        hidden = self.tanh(self.hidden(concat))
        output = self.log_softmax(self.output(concat))
